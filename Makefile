...
.PHONY: docs-ref
docs-ref:
	@echo "See http://localhost:$${GODOC_PORT:-6060}/pkg/github.com/ntrrg/tiler"
...
clean-dev: clean
	rm -rf $(coverage_file)
	docker image rm ntrrg/tiler || true
...
qa: $(make_bin)/gometalinter
	PATH="$(make_bin):$$PATH" gometalinter --tests ./ ./pkg/...
